...
ActiveRecord::Schema[7.1].define(version: 2025_05_15_221110) do
  ...
  add_foreign_key "equipment_maintenance_histories", "equipments"
  ...
  add_foreign_key "equipment_maintenance_schedules", "equipments"
  ...
  add_foreign_key "price_table_items", "equipments"
  ...
  add_foreign_key "quotation_items", "equipments"
  ...
  add_foreign_key "rental_billing_items", "equipments"
  ...
  add_foreign_key "rental_items", "equipments"
  add_foreign_key "rental_items", "rentals"
  add_foreign_key "rental_items", "tenants"
  add_foreign_key "rental_movement_items", "equipments"
  ...
  add_foreign_key "service_order_items", "equipments"
  ...
  add_foreign_key "service_requests", "equipments"
